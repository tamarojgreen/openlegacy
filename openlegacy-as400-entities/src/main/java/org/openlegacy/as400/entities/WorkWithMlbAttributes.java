...
@ScreenIdentifiers(identifiers = { 
				@Identifier(row = 1, column = 29, value = "Work with MLB Attributes") 
				})
...
@ScreenNavigation(accessedFrom = WorkWithJobMenu.class, exitAction = F12.class, assignedFields = { @AssignedField(field = "menuSelection", value = "21") })
public class WorkWithMlbAttributes {
	...
	@ScreenField(row = 20, column = 7, endColumn = 80, editable = true, displayName = "Command")
