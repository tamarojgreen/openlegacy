 ...
 * 
 */
public class FieldsJpaBooleanFieldDetailsPage extends AbstractJpaFieldDetailsPage {

	private JpaBooleanFieldModel fieldModel;

	public FieldsJpaBooleanFieldDetailsPage(AbstractMasterBlock master) {
		super(master);
	}
	...
	public Class<?> getDetailsModel() {
		return JpaBooleanFieldModel.class;
	}
	...
	protected void selectionChanged(IStructuredSelection selection) {
		if (selection.size() == 1) {
			fieldModel = (JpaBooleanFieldModel)selection.getFirstElement();
		} else {
			fieldModel = null;
		}
	}
