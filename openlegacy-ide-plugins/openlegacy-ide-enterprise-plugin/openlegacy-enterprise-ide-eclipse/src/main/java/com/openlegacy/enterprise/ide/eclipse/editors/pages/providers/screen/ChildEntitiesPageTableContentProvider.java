 ...
 * 
 */
public class ChildEntitiesPageTableContentProvider implements IStructuredContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		if (inputElement instanceof ScreenEntity) {
			return ((ScreenEntity)inputElement).getSortedChildEntities().toArray();
		}
		return new Object[] {};
	}
