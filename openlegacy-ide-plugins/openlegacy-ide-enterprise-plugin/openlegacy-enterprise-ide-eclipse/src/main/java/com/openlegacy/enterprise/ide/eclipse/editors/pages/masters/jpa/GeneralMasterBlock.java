 ...
 * 
 */
public class GeneralMasterBlock extends AbstractJpaEntityMasterBlock {
	...
	protected void createMasterPart(final IManagedForm managedForm, Composite parent) {
		...
		section.setText(Messages.getString("jpa.general.page.master.block.text")); //$NON-NLS-1$
		section.setDescription(Messages.getString("jpa.general.page.master.block.desc")); //$NON-NLS-1$
