 ...
 * 
 */
public class JpaByteFieldModel extends JpaFieldModel {

	public JpaByteFieldModel(NamedObject parent) {
		super(parent);
		this.javaTypeName = Messages.getString("type.byte");//$NON-NLS-1$
	}

	public JpaByteFieldModel(UUID uuid, NamedObject parent) {
		super(uuid, parent);
		this.javaTypeName = Messages.getString("type.byte");//$NON-NLS-1$
	}
	...
	public JpaFieldModel clone() {
		JpaByteFieldModel model = new JpaByteFieldModel(uuid, parent);
