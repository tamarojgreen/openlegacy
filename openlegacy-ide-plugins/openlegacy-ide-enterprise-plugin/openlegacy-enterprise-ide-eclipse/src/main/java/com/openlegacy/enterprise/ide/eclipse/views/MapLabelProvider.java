...
public class MapLabelProvider extends LabelProvider implements
	...
	public Image getImage(Object element) {
		if (element instanceof ScreenEntityModel){
			Image image = generateImage(PlatformUI.getWorkbench()
					.getDisplay(), ((ScreenEntityModel) element).getTerminalSnapshot(),
					new DefaultTerminalSnapshotImageRenderer());
			return image;
		}
	...
	public static Image generateImage(Display display, TerminalSnapshot terminalSnapshot, DefaultTerminalSnapshotImageRenderer renderer){
		...
		Image scaledImage = new Image(Display.getDefault(), image
