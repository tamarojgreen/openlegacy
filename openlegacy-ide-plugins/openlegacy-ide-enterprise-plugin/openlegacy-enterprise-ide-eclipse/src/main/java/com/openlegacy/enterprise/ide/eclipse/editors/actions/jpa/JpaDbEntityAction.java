 ...
 * 
 */
public class JpaDbEntityAction extends AbstractAction {

	public JpaDbEntityAction(UUID uuid, NamedObject namedObject, ActionType actionType, int kind, String key, Object value) {
