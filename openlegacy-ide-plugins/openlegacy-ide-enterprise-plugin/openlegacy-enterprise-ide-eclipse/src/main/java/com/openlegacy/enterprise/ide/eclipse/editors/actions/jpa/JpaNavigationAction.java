 ...
 * 
 */
public class JpaNavigationAction extends AbstractAction {

	public JpaNavigationAction(UUID uuid, NamedObject namedObject, ActionType actionType, int kind, String key, Object value) {
		super(uuid, namedObject, actionType, kind, key, value);
	}

	@Override
	public Class<?> getAnnotationClass() {
		return DbNavigation.class;
	}
