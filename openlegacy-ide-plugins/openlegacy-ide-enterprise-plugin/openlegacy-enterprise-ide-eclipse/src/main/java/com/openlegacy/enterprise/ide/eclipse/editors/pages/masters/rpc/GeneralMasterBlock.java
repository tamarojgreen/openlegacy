...
import com.openlegacy.enterprise.ide.eclipse.editors.pages.details.rpc.GeneralRpcEntityDetailsPage;
import com.openlegacy.enterprise.ide.eclipse.editors.pages.details.rpc.GeneralRpcNavigationDetailsPage;
import com.openlegacy.enterprise.ide.eclipse.editors.pages.providers.rpc.GeneralMasterBlockContentProvider;
import com.openlegacy.enterprise.ide.eclipse.editors.pages.providers.rpc.GeneralMasterBlockLabelProvider;
 ...
 * 
 */
public class GeneralMasterBlock extends AbstractRpcEntityMasterBlock {
	...
	protected void createMasterPart(final IManagedForm managedForm, Composite parent) {
		...
		section.setText(Messages.getString("rpc.general.page.master.block.text")); //$NON-NLS-1$
		section.setDescription(Messages.getString("rpc.general.page.master.block.desc")); //$NON-NLS-1$
	...
	protected void registerPages(DetailsPart detailsPart) {
		detailsPages.add(new GeneralRpcEntityDetailsPage(this));
		detailsPages.add(new GeneralRpcNavigationDetailsPage(this));
		for (IDetailsPage page : detailsPages) {
