...
public abstract class AbstractMasterBlock extends MasterDetailsBlock implements IOpenLegacyMasterBlock {
	...
	protected void createToolBarActions(IManagedForm managedForm) {
		...
		haction.setImageDescriptor(Activator.getDefault().getImageDescriptor(Activator.IMG_HORIZONTAL));
		...
		vaction.setImageDescriptor(Activator.getDefault().getImageDescriptor(Activator.IMG_VERTICAL));
