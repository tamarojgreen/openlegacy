...
public class TablesScreenColumnDetailsPage extends AbstractScreenDetailsPage {
	...
	public void createContents(Composite parent) {
		...
		FormRowCreator.createLabelRow(toolkit, client, mapLabels, Messages.getString("ScreenColumn.javaType"), "",//$NON-NLS-1$ //$NON-NLS-2$
				Constants.JAVA_TYPE_NAME, JAVA_DOCUMENTATION_TYPE.JAVA_BASICS, "variables", "naming");//$NON-NLS-1$ //$NON-NLS-2$
		// create row for "fieldName"
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("ScreenColumn.fieldName"), "", Constants.FIELD_NAME, JAVA_DOCUMENTATION_TYPE.SCREEN,//$NON-NLS-1$ //$NON-NLS-2$
				"ScreenColumn", Constants.FIELD_NAME);//$NON-NLS-1$
		// create row for "key"
		FormRowCreator.createBooleanRow(toolkit, client, mapCheckBoxes, getDefaultSelectionListener(),
				Messages.getString("ScreenColumn.key"), false, AnnotationConstants.KEY, JAVA_DOCUMENTATION_TYPE.SCREEN,//$NON-NLS-1$
				"ScreenColumn", AnnotationConstants.KEY);//$NON-NLS-1$
		...
		FormRowCreator.createBooleanRow(toolkit, client, mapCheckBoxes, getSelectionFieldListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", ScreenAnnotationConstants.SELECTION_FIELD);//$NON-NLS-1$
		...
		FormRowCreator.createBooleanRow(toolkit, client, mapCheckBoxes, getDefaultSelectionListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", AnnotationConstants.MAIN_DISPLAY_FIELD);//$NON-NLS-1$
		...
		Text startColumnControl = FormRowCreator.createIntRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				getDefaultVerifyListener(), Messages.getString("ScreenColumn.startColumn"), -1,//$NON-NLS-1$
				ScreenAnnotationConstants.START_COLUMN, JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn",//$NON-NLS-1$
				ScreenAnnotationConstants.START_COLUMN);
		...
		Text endColumnControl = FormRowCreator.createIntRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				getDefaultVerifyListener(), Messages.getString("ScreenColumn.endColumn"), -1,//$NON-NLS-1$
				ScreenAnnotationConstants.END_COLUMN, JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn",//$NON-NLS-1$
		...
		editableButton = FormRowCreator.createBooleanRow(toolkit, client, mapCheckBoxes, getDefaultSelectionListener(),
				Messages.getString("ScreenColumn.editable"), false, AnnotationConstants.EDITABLE, JAVA_DOCUMENTATION_TYPE.SCREEN,
				"ScreenColumn", AnnotationConstants.EDITABLE);
		// create row for "displayName"
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("ScreenColumn.displayName"), "", AnnotationConstants.DISPLAY_NAME,//$NON-NLS-1$ //$NON-NLS-2$
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", AnnotationConstants.DISPLAY_NAME);//$NON-NLS-1$
		// create row for "sampleValue"
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("ScreenColumn.sampleValue"), "", AnnotationConstants.SAMPLE_VALUE,//$NON-NLS-1$ //$NON-NLS-2$
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", AnnotationConstants.SAMPLE_VALUE);//$NON-NLS-1$
		...
		FormRowCreator.createIntRow(toolkit, client, mapTexts, getDefaultModifyListener(), getDefaultVerifyListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", ScreenAnnotationConstants.ROWS_OFFSET);//$NON-NLS-1$
		// create row for "helpText"
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("ScreenColumn.helpText"), "", AnnotationConstants.HELP_TEXT, JAVA_DOCUMENTATION_TYPE.SCREEN,//$NON-NLS-1$ //$NON-NLS-2$
				"ScreenColumn", AnnotationConstants.HELP_TEXT);//$NON-NLS-1$
		// create row for "colSpan"
		FormRowCreator.createIntRow(toolkit, client, mapTexts, getDefaultModifyListener(), getDefaultVerifyListener(),
				Messages.getString("ScreenColumn.colSpan"), 1, ScreenAnnotationConstants.COL_SPAN,//$NON-NLS-1$
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", ScreenAnnotationConstants.COL_SPAN);//$NON-NLS-1$
		// create row for "sortIndex"
		FormRowCreator.createIntRow(toolkit, client, mapTexts, getDefaultModifyListener(), getDefaultVerifyListener(),
				Messages.getString("ScreenColumn.sortIndex"), -1, ScreenAnnotationConstants.SORT_INDEX,//$NON-NLS-1$
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", ScreenAnnotationConstants.SORT_INDEX);//$NON-NLS-1$
		...
		FormRowCreator.createComboBoxRow(toolkit, client, mapCombos, getDefaultModifyListener(), getDefaultComboBoxKeyListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", AnnotationConstants.ATTRIBUTE);//$NON-NLS-1$
		...
		FormRowCreator.createStringRowWithBrowseButton(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("ScreenColumn.targetEntity"), "", ScreenAnnotationConstants.TARGET_ENTITY, null,//$NON-NLS-1$ //$NON-NLS-2$
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", ScreenAnnotationConstants.TARGET_ENTITY);//$NON-NLS-1$
		...
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenColumn", ScreenAnnotationConstants.EXPRESSION);//$NON-NLS-1$
