...
public class FieldsJpaListFieldDetailsPage extends AbstractJpaFieldDetailsPage {
	...
	protected void addBottomContent(FormToolkit toolkit, Composite client) {
		...
		FormRowCreator.createComboBoxRow(toolkit, composite, mapCombos, getDefaultModifyListener(),
				...
				DbAnnotationConstants.CASCADE, false, JAVA_DOCUMENTATION_TYPE.JPA, "OneToMany", DbAnnotationConstants.CASCADE);//$NON-NLS-1$
		...
		FormRowCreator.createComboBoxRow(toolkit, composite, mapCombos, getDefaultModifyListener(),
				...
				DbAnnotationConstants.FETCH, false, JAVA_DOCUMENTATION_TYPE.JPA, "OneToMany", DbAnnotationConstants.FETCH);//$NON-NLS-1$
		// create row for "mappedBy"
		FormRowCreator.createStringRow(toolkit, composite, mapTexts, getDefaultModifyListener(),
				Messages.getString("jpa.field.list.mapped.by"), "", DbAnnotationConstants.MAPPED_BY, JAVA_DOCUMENTATION_TYPE.JPA,//$NON-NLS-1$ //$NON-NLS-2$
				"OneToMany", DbAnnotationConstants.MAPPED_BY);//$NON-NLS-1$
		...
		FormRowCreator.createBooleanRow(toolkit, composite, mapCheckBoxes, getDefaultSelectionListener(),
				...
				JAVA_DOCUMENTATION_TYPE.JPA, "OneToMany", DbAnnotationConstants.ORPHAN_REMOVAL);//$NON-NLS-1$
		...
		targetEntityControl = FormRowCreator.createStringRowWithBrowseButton(toolkit, composite, mapTexts,
				...
				"OneToMany", DbAnnotationConstants.TARGET_ENTITY);//$NON-NLS-1$
