 ...
 * 
 */
public class FieldsJpaByteFieldDetailsPage extends AbstractJpaFieldDetailsPage {

	private JpaByteFieldModel fieldModel;

	public FieldsJpaByteFieldDetailsPage(AbstractMasterBlock master) {
		super(master);
	}
	...
	public Class<?> getDetailsModel() {
		return JpaByteFieldModel.class;
	}
	...
	protected void selectionChanged(IStructuredSelection selection) {
		if (selection.size() == 1) {
			fieldModel = (JpaByteFieldModel)selection.getFirstElement();
		} else {
			fieldModel = null;
		}
	}
