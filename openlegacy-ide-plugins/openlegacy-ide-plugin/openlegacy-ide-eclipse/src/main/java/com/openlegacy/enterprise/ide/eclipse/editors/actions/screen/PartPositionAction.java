 ...
 * 
 */
public class PartPositionAction extends AbstractAction {
	 ...
	 * @param value
	 */
	public PartPositionAction(UUID uuid, NamedObject namedObject, ActionType actionType, int kind, String key, Object value) {
		super(uuid, namedObject, actionType, kind, key, value);
	}

	@Override
	public Class<?> getAnnotationClass() {
		return PartPosition.class;
	}
