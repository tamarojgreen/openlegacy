...
public class TablesScreenTableDetailsPage extends AbstractScreenDetailsPage {
	...
	public void createContents(Composite parent) {
		...
		Text classNameControl = FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("ScreenTable.className"), "", Constants.JAVA_TYPE_NAME, JAVA_DOCUMENTATION_TYPE.JAVA_BASICS,//$NON-NLS-1$ //$NON-NLS-2$
				"datatypes", "");//$NON-NLS-1$ //$NON-NLS-2$
		...
		Text startRowControl = FormRowCreator.createIntRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenTable", ScreenAnnotationConstants.START_ROW);//$NON-NLS-1$
		...
		Text endRowControl = FormRowCreator.createIntRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenTable", ScreenAnnotationConstants.END_ROW);//$NON-NLS-1$
		...
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("ScreenTable.name"), "", AnnotationConstants.NAME, JAVA_DOCUMENTATION_TYPE.SCREEN,//$NON-NLS-1$ //$NON-NLS-2$
				"ScreenTable", AnnotationConstants.NAME);//$NON-NLS-1$
		...
		FormRowCreator.createComboBoxRowWithBrowseButton(toolkit, client, mapCombos, getDefaultModifyListener(),
				...
				ScreenAnnotationConstants.NEXT_SCREEN_ACTION, new TerminalActionViewerFilter(), JAVA_DOCUMENTATION_TYPE.SCREEN,
				"ScreenTable", ScreenAnnotationConstants.NEXT_SCREEN_ACTION);//$NON-NLS-1$
		...
		FormRowCreator.createComboBoxRowWithBrowseButton(toolkit, client, mapCombos, getDefaultModifyListener(),
				...
				ScreenAnnotationConstants.PREV_SCREEN_ACTION, new TerminalActionViewerFilter(), JAVA_DOCUMENTATION_TYPE.SCREEN,
				"ScreenTable", ScreenAnnotationConstants.PREV_SCREEN_ACTION);//$NON-NLS-1$
		...
		FormRowCreator.createBooleanRow(toolkit, client, mapCheckBoxes, getDefaultSelectionListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenTable", ScreenAnnotationConstants.SUPPORT_TERMINAL_DATA);//$NON-NLS-1$
		// create row for "scrollable"
		FormRowCreator.createBooleanRow(toolkit, client, mapCheckBoxes, getDefaultSelectionListener(),
				Messages.getString("ScreenTable.scrollable"), true, ScreenAnnotationConstants.SCROLLABLE,//$NON-NLS-1$
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenTable", ScreenAnnotationConstants.SCROLLABLE);//$NON-NLS-1$
		...
		FormRowCreator.createStringRowWithBrowseButton(toolkit, client, mapTexts, getDefaultModifyListener(),
				...
				new TableCollectorViewerFilter(), JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenTable",//$NON-NLS-1$
				ScreenAnnotationConstants.TABLE_COLLECTOR);
		...
		FormRowCreator.createIntRow(toolkit, client, mapTexts, getDefaultModifyListener(), getDefaultVerifyListener(),
				Messages.getString("ScreenTable.rowGaps"), 1, ScreenAnnotationConstants.ROW_GAPS, JAVA_DOCUMENTATION_TYPE.SCREEN,//$NON-NLS-1$
				"ScreenTable", ScreenAnnotationConstants.ROW_GAPS);//$NON-NLS-1$
		...
		FormRowCreator.createIntRow(toolkit, client, mapTexts, getDefaultModifyListener(), getDefaultVerifyListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenTable", ScreenAnnotationConstants.SCREENS_COUNT);//$NON-NLS-1$
		...
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "ScreenTable", ScreenAnnotationConstants.FILTER_EXPRESSION);//$NON-NLS-1$
		...
		FormRowCreator.createBooleanRow(toolkit, client, mapCheckBoxes, getDefaultSelectionListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "", ScreenAnnotationConstants.RIGHT_TO_LEFT);//$NON-NLS-1$
		...
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				...
				JAVA_DOCUMENTATION_TYPE.SCREEN, "", ScreenAnnotationConstants.STOP_EXPRESSION);//$NON-NLS-1$
