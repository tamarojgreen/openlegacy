 ...
 *
 */
public abstract class ComboValidator {
	...
	public ComboValidator(IOpenLegacyMasterBlock masterBlock, IManagedForm managedForm, CCombo control, UUID modelUuid) {
	...
	protected abstract boolean validateControl(ComboValidator validator, UUID uuid);
