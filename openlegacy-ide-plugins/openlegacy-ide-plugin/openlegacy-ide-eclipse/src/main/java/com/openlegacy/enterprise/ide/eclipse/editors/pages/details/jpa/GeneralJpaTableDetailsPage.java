...
public class GeneralJpaTableDetailsPage extends AbstractJpaDetailsPage {
	...
	public void createContents(Composite parent) {
		...
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("jpa.table.name"), "", DbAnnotationConstants.NAME, JAVA_DOCUMENTATION_TYPE.JPA, "Table");//$NON-NLS-1$ //$NON-NLS-2$
		// create row for "catalog"
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("jpa.table.catalog"), "", DbAnnotationConstants.CATALOG, JAVA_DOCUMENTATION_TYPE.JPA, "Table");//$NON-NLS-1$ //$NON-NLS-2$
		// create row for "name"
		FormRowCreator.createStringRow(toolkit, client, mapTexts, getDefaultModifyListener(),
				Messages.getString("jpa.table.schema"), "", DbAnnotationConstants.SCHEMA, JAVA_DOCUMENTATION_TYPE.JPA, "Table");//$NON-NLS-1$ //$NON-NLS-2$
