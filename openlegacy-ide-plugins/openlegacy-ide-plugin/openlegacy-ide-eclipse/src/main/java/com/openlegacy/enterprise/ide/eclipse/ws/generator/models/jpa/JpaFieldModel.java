 ...
 * 
 */
public class JpaFieldModel extends AbstractNamedModel {

	private DbFieldDefinition definition = null;

	public JpaFieldModel(DbFieldDefinition definition, AbstractNamedModel parent) {
		super(definition.getName(), parent);
		this.definition = definition;
	}

	public DbFieldDefinition getDefinition() {
		return definition;
	}
