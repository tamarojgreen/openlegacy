 ...
 * 
 */
public class FieldsJpaStringFieldDetailsPage extends AbstractJpaFieldDetailsPage {

	private JpaFieldModel fieldModel;

	public FieldsJpaStringFieldDetailsPage(AbstractMasterBlock master) {
		super(master);
	}
	...
	protected void selectionChanged(IStructuredSelection selection) {
		if (selection.size() == 1) {
			fieldModel = (JpaFieldModel)selection.getFirstElement();
		} else {
			fieldModel = null;
		}
	}
