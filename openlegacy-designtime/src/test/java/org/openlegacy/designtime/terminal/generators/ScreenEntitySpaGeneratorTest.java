...
@ContextConfiguration("ScreenEntitySpaGeneratorTest-context.xml")
@RunWith(SpringJUnit4ClassRunner.class)
public class ScreenEntitySpaGeneratorTest {
	...
	public void testGenerateHtmlByCodeModel() throws Exception {
		...
		assertPageGeneration(screenDefinition, "ScreenForPage2.html.expected");
	}
