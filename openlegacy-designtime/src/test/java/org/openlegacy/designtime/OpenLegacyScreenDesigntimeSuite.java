...
import org.openlegacy.designtime.terminal.generators.ScreenEntitySpaBidiGeneratorTest;
...
@SuiteClasses({ AnalyzerSuite.class, ScreenEntityAjGeneratorTest.class, DefaultTerminalSnapshotsSorterTest.class,
		...
		ScreenEntitySpaGeneratorTest.class, ScreenEntitySpaBidiGeneratorTest.class, HelpGeneratorTest.class })
