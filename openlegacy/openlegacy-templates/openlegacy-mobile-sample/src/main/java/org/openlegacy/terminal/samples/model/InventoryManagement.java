...
@ScreenEntity(screenType = MenuEntity.class, displayName = "Inventory Menu")
...
@ScreenNavigation(accessedFrom = DemoEnvironment.class, assignedFields = { @AssignedField(field = "menuSelection", value = "1") })
