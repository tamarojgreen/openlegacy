...
privileged @SuppressWarnings("unused") aspect ItemDetailesRecord_Aspect {
    ...
    public void ItemDetailesRecord.setAlphaSearch(String alphaSearch){
    ...
    public void ItemDetailesRecord.setItemDescription(String itemDescription){
    ...
    public void ItemDetailesRecord.setItemNumber(String itemNumber){
