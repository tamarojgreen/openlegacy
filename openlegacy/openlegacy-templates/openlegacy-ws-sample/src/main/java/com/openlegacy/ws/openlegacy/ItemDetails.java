...
@ScreenNavigation(accessedFrom = Items.class, drilldownValue = "5", exitAction = F12.class, assignedFields = { @AssignedField(field = "act", value = "5") })
public class ItemDetails {
    
	
	@ScreenField(key = true, row = 6, column = 33, endColumn = 52, labelColumn = 2, displayName = "Item Number")
