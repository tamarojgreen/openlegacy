...
@ScreenNavigation(accessedFrom = Warehouses.class, exitAction = F12.class, drilldownValue = "5", assignedFields = { @AssignedField(field = "act", value = "5") })
public class WarehouseDetails {
	...
	@ScreenField(key = true, endColumn = 36, row = 6, column = 34, labelColumn = 2, sampleValue = "1", endRow = 6, displayName = "Warehouse Number")
