...
aspect ItemDetails2_Aspect {
	...
	public void ItemDetails2.setItemNumberdesc(Integer itemNumberdesc) {
		this.itemNumberdesc = itemNumberdesc;
	}
	...
	public void ItemDetails2.setStockInfo(StockInfo stockInfo) {
