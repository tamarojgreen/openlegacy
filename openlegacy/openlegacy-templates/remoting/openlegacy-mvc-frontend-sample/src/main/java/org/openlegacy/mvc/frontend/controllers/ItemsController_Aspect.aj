...
import org.openlegacy.mvc.remoting.entities.Items;
...
privileged aspect ItemsController_Aspect {
	...
	public @ResponseBody
	String ItemsController.systemHelp(HttpServletRequest request) throws IOException {
