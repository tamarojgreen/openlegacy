...
import org.openlegacy.mvc.remoting.entities.MainMenu;
...
privileged aspect MainMenuController_Aspect {
	...
	public @ResponseBody
	String MainMenuController.systemHelp(HttpServletRequest request) throws IOException {
