(function() {
	...
	module = module.controller('emulationCtrl',	function($scope, $olHttp, $rootScope, $state, $stateParams, $templateCache) {
	...
	module = module.controller('loginCtrl', function($scope, $olHttp, $rootScope, $state, $stateParams, $idleTimeout) {
				$scope.login = function(username, password) {				
				var userData = {"user":username,"password":password}
				$olHttp.post('login', userData, function(data) {
		...
		module = module.controller('headerCtrl', function ($rootScope, $scope, $http, $themeService, $olHttp, $modal, $state, $idleTimeout) {			
		...
		module = module.controller('menuCtrl', function($scope, flatMenu, $state, $rootScope, $olHttp) {
