 ...
 * perform a working scenario which goes through the relevant screens. Can be tested by invoking the test ItemsServiceTest. The
 * interface ItemsService can be customized to enabling passing parameters to the service, and this class can consume the
 * parameters within the relavant screens.
 */
