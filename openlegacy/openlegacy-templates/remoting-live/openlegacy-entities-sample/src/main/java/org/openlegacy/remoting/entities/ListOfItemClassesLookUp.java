...
@ScreenIdentifiers(identifiers = { @Identifier(row = 5, column = 20, value = "     List of Item Classes     "),
...
public class ListOfItemClassesLookUp implements Serializable {
	...
	public static class ListOfItemClassesRecord implements Serializable {
