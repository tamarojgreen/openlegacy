...
@ScreenIdentifiers(identifiers = { @Identifier(row = 1, column = 34, value = "Work with Job"),
...
@ScreenNavigation(accessedFrom = UserTasks.class, assignedFields = { @AssignedField(field = "menuSelection", value = "1") })
public class WorkWithJob implements Serializable {
