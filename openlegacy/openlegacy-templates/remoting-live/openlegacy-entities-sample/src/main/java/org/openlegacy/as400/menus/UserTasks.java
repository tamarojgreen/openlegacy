...
@ScreenIdentifiers(identifiers = { @Identifier(row = 1, column = 36, value = "User Tasks"),
...
@ScreenNavigation(accessedFrom = IbmIMainMenu.class, assignedFields = { @AssignedField(field = "menuSelection", value = "1") })
