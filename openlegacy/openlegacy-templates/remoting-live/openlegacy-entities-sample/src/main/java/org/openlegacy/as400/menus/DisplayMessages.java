...
@ScreenIdentifiers(identifiers = { @Identifier(row = 1, column = 25, value = "        Display Messages        "),
		@Identifier(row = 4, column = 4, value = "Library . . . :"), @Identifier(row = 4, column = 48, value = "Library . . . :") })
