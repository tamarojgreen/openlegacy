...
privileged @SuppressWarnings("unused") aspect CopyFromPcDocumentcpyfrmpcd_Aspect {
    ...
    private List<TerminalActionDefinition> CopyFromPcDocumentcpyfrmpcd.actions = new ArrayList<TerminalActionDefinition>();
    ...
    public List<TerminalActionDefinition> CopyFromPcDocumentcpyfrmpcd.getActions(){
    	return actions;
    }
