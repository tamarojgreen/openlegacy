...
@ScreenIdentifiers(identifiers = { @Identifier(row = 1, column = 33, value = "Decision Support"),
...
@ScreenNavigation(accessedFrom = OfficeTasks.class, assignedFields = { @AssignedField(field = "menuSelection", value = "3") })
