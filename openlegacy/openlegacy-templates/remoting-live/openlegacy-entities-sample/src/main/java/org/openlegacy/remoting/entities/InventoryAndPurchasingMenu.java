...
@ScreenIdentifiers(identifiers = { @Identifier(row = 1, column = 26, value = "** Inventory and Purchasing **"),
...
public class InventoryAndPurchasingMenu implements Serializable {
