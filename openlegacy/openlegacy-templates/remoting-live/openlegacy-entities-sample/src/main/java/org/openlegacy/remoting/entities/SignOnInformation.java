...
@ScreenIdentifiers(identifiers = { @Identifier(row = 1, column = 31, value = "Sign-on Information") })
@ScreenActions(actions = { @Action(action = TerminalActions.F9.class, displayName = "Change password", alias = "changePassword") })
public class SignOnInformation implements Serializable {
