...
@ScreenIdentifiers(identifiers = { 
				@Identifier(row = 1, column = 23, value = "Interactive Data Definition Utility"), 
...
@ScreenNavigation(accessedFrom = DecisionSupport.class 
					, assignedFields = { 
					@AssignedField(field = "menuSelection", value = "1")
					 }						
					)
public class InteractiveDataDefinitionUtility {
