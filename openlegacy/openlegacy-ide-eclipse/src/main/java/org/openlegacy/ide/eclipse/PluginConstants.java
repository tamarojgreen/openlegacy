...
public class PluginConstants {
	...
	public static final String PLUGIN_ID = "org.openlegacy.ide.eclipse";

	public static final String PROJECT_FILE = ".project";
	public static final String JAVA_EXTENSION = "java";

	public static final String OPENLEGACY_PROJECT_NATURE_ID = "org.openlegacy.ide.eclipse.nature";
