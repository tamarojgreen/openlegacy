...
public class CallCobolProgramTreePcml {
	...
	public static void main(String[] args) throws PcmlException, FileNotFoundException, IOException {
		...
		ProgramCallDocument newPcml = new ProgramCallDocument(as400System, "com.as400samplecode.cobol_tree");
		// newPcml.serialize(new FileOutputStream("cobol_structure.ser"));
		// newPcml.serialize();

		newPcml.setValue("cobol_tree.top.param1.child1", 10);
		newPcml.setValue("cobol_tree.top.param1.child2", 0);
		boolean result = newPcml.callProgram("cobol_tree");

		if (result == false) {
			AS400Message[] msgs = newPcml.getMessageList("cobol_tree");
		...
		System.out.println("child2=" + newPcml.getValue("cobol_tree.top.param1.child2"));
