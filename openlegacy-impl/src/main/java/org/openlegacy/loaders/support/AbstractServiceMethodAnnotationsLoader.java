...
public abstract class AbstractServiceMethodAnnotationsLoader implements ServiceMethodAnnotationsLoader {

	@Override
	public int compareTo(ServiceMethodAnnotationsLoader o) {
