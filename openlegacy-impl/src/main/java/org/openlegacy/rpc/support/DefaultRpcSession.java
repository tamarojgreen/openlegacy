...
public class DefaultRpcSession extends AbstractSession implements RpcSession {
	...
	@Inject
	private List<RpcFieldConverter> rpcFieldConvertors;
	...
	private void converToLegacyFields(RpcInvokeAction rpcAction) {
		...
		for (RpcFieldConverter fpcFieldConvertor : rpcFieldConvertors) {
			fpcFieldConvertor.toLegacy(rpcAction.getFields());
		}
	...
	private void converToApiFields(RpcInvokeAction rpcAction) {
		...
		for (RpcFieldConverter fpcFieldConvertor : rpcFieldConvertors) {
			fpcFieldConvertor.toApi(rpcAction.getFields());
		}
