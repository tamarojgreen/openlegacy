...
public class TerminalConnectionDelegator implements TerminalConnection, Serializable {
	...
	private void lazyConnect() {
		if (terminalConnection == null) {
			...
			if (isLiveSession){
				terminalConnectionFactory = applicationContext.getBean(LiveHostTerminalConnectionFactory.class);
			}else{
				terminalConnectionFactory = applicationContext.getBean(MockHostTerminalConnectionFactory.class);
			}
