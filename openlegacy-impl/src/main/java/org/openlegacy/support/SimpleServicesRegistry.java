...
public class SimpleServicesRegistry implements WebServicesRegistry {
	...
	@Override
	public ServiceDefinition getWebServiceByName(String name) {
		if (webServices != null) {
	...
	@Override
	public ServiceDefinition getWebServiceByClass(Class<?> clazz) {
