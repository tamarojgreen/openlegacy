...
public class RegistryTest {
	...
	public void testFieldTypes() {
		...
		Assert.assertEquals(2, enumFieldTypeDefinition.getEnums().size());
		DisplayItem displayItem = enumFieldTypeDefinition.getEnums().get("kg");
		Assert.assertEquals(OuterUnitOfMeasure.Kilogram, displayItem.getValue());
